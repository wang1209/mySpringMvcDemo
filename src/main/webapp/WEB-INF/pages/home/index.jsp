...
<head>
  ...
  <link href="<c:url value='/resources/plugins/fullcalendar/fullcalendar/fullcalendar.css'/>" rel="stylesheet" type="text/css"/>
...
<script src="<c:url value='/resources/plugins/gritter/js/jquery.gritter.js'/>" type="text/javascript"></script>
<!-- IMPORTANT! fullcalendar depends on jquery-ui-1.10.3.custom.min.js for drag & drop support -->
<script src="<c:url value='/resources/plugins/fullcalendar/fullcalendar/fullcalendar.min.js'/>" type="text/javascript"></script>
<script src="<c:url value='/resources/plugins/jquery.sparkline.min.js'/>" type="text/javascript"></script>
