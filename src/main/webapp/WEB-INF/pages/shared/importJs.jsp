...
<!-- BEGIN CORE PLUGINS -->
	...
	<script src="<c:url value='/resources/plugins/excanvas.min.js'/>" type="text/javascript"></script>
	<![endif]-->   
	...
	<script src="<c:url value='/resources/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js'/>" type="text/javascript" ></script>
